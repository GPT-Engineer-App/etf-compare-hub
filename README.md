...
**Project**: etf-compare-hub 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: I want to be able to track ETFs. Within each ETF I want to be able to see a breakdown of companies that belong to it, and then compare ETFs with each other. 
...
```sh
git clone https://github.com/GPT-Engineer-App/etf-compare-hub.git
cd etf-compare-hub
npm i
